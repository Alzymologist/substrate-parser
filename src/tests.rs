use crate::{parse_transaction, display_transaction};
...
fn tr_1() {
    ...
    let parsed = parse_transaction(&mut data.clone(), &metadata("for_tests/westend9111")).unwrap();
    println!("{:?}", parsed);
    
    let reply =
        display_transaction(&mut data, &metadata("for_tests/westend9111"), &specs()).unwrap();
    let reply_known = r#"
Call:
...
fn tr_5() {
    ...
    let reply =
        display_transaction(&mut data, &metadata("for_tests/westend9122"), &specs()).unwrap();
    let reply_known = "
Call:
...
fn tr_6() {
    ...
    let reply =
        display_transaction(&mut data, &metadata("for_tests/acala2012"), &specs_acala).unwrap();
    let reply_known = r#"
Call:
